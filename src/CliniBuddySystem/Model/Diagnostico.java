...
public class Diagnostico extends Info {
    ...
    public Diagnostico(String veterinarioResponsavel, String doenca, String descricao, String tratamentoSugerido,
            String riscos, String observacoes) {
    ...
    public void setDoenca(String novaDoenca) {
        this.doenca = novaDoenca;
    }
