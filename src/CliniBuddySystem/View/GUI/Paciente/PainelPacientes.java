package CliniBuddySystem.View.GUI.Paciente;
...
public class PainelPacientes extends JPanel {
    ...
    private final PainelAgendamentos pa;
    private final PainelHistorico ph;
    private final PainelDiagnostico pd;
    ...
    public PainelPacientes(GerenciadorPaciente gp, PainelAgendamentos pa, PainelHistorico ph, PainelDiagnostico pd) {
        this.gp = gp;
        this.pa = pa;
        this.ph = ph;
        this.pd = pd;
    ...
    private DefaultTableModel criarModeloTabela() {
        String[] colunas = { "Nome", "Espécie", "Raça", "Idade", "Peso(Kg)" };
                ...
                new ActionListener() {
                    ...
                    public void actionPerformed(java.awt.event.ActionEvent e) {
                        ...
                        try {
                            ...
                            peso = Float.parseFloat(campoPeso.getText().replace(",", "."));
                            ...
                            JOptionPane.showMessageDialog(null, ex.getMessage(), "Erro de Cadastro",
                        ...
                        campoPeso.setText("");
                        campoRaça.setText("");
                        pa.recarregarPacientes();
                        ph.recarregarPacientes();
                        pd.recarregarPacientes();
                        atualizarTabela();
                    }
                });
